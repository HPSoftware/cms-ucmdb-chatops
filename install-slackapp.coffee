installSlackApp = require './install-slackapp.js';
...
cs= process.argv[3]
name = process.argv[4]
httpProxy = process.argv[5]
httpsProxy = process.argv[6]
  ...
  if not err
    ...
    controller.setupWebserver port, (err, webserver)->
      ...
      <html>
        ...
        <body>
          <div id="center">
            <h1>Add cms-ucmdb-chatops bot to your Slack Team</h1>
    ...
    handleEvent = (bot, user)->
      ...
      dataStore.save name,{
         ...
         installSlackApp.createStartFiles apiToken, botToken, httpProxy, httpsProxy
